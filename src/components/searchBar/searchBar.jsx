...
const SearchBar = ({searchCharacters}) => {
    return (
        <div className="input-group input-wrapper  rounded-2 align-items-center d-none d-lg-flex" >
            ...
            <input type="search"  className="form-control border border-0" placeholder="Search..." onChange={(e) => searchCharacters(e.target.value)}/>
